...
.stSelectbox > div > div { border-radius:9px !important; border-color:var(--border) !important; font-size:0.85rem !important; background:var(--surface) !important; }
...
<div class="pcard" style="flex-direction:column;align-items:flex-start;gap:0.28rem;">
    <div style="display:flex;align-items:center;gap:0.55rem">
        {dot_html(d['hex'],24)} <b style="font-size:0.83rem">{pn}</b>{'&nbsp;'+new_tag() if d.get('new') else ''}
    </div>
